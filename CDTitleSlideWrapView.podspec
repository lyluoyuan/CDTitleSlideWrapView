...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CDTitleSlideWrapView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lyluoyuan@126.com/CDTitleSlideWrapView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lyluoyuan@126.com' => 'lyluoyuan@126.com' }
  s.source           = { :git => 'https://github.com/lyluoyuan@126.com/CDTitleSlideWrapView.git', :tag => s.version.to_s }
